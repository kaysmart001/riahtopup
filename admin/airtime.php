...
include('db.php');
 ...
 $result = $conn->query("SELECT * FROM airtime ");
...
<body class="sb-nav-fixed">
		 ...
		 <table class="table table-hover" width="100%" style="text-align: center;  border:  1px solid #eee; ">
		    ...
		    <tbody>
                    ...
                    foreach($customer as $customer) :?>
						<tr>
							<td><?= $customer['id']; ?></td>
                            <td><?= $customer['airtime_name']; ?></td>
							
							
							<td class="text-center"><a type="button" style="color:#fff;" class="btn btn-success editbtn">ADD CABLE PLAN</a></td>
  ...
  <div class="modal-dialog" role="document">
    ...
    <form  action="airtime_price.php" method="post">
    ...
    <div class="form-group">
      ...
      <small id="" class="form-text text-muted"></small>
         ...
         <br>
    <button type="submit" name="add" class="btn btn-primary">Add AIRTIME Plan</button>
  </form>
