		 ...
		 <table class="table table-hover" width="100%" style="text-align: center;  border:  1px solid #eee; ">
		    ...
		    <tbody>
                    <?php
                     ...
                     $result = $conn->query("SELECT * FROM dataprice ");
                     $customer = $result->fetch_all(MYSQLI_ASSOC);
                    foreach($customer as $customer) :?>
						<tr>
							<td><?= $customer['id']; ?></td>
                            <td><?= $customer['data_type']; ?></td>
...
<table class="table table-hover" width="100%" style="text-align: center;  border:  1px solid #eee; ">
		    ...
		    <tbody>
                    <?php
                     ...
                     $result = $conn->query("SELECT * FROM cableprice ");
                     $customer = $result->fetch_all(MYSQLI_ASSOC);
                    foreach($customer as $customer) :?>
						<tr>
							<td><?= $customer['id']; ?></td>
                            <td><?= $customer['cable_type']; ?></td>
                            <td>₦<?= $customer['cable_price']; ?></td>
...
<table class="table table-hover" width="100%" style="text-align: center;  border:  1px solid #eee; ">
		    ...
		    <tbody>
                    <?php
                     ...
                     $result = $conn->query("SELECT * FROM airtimeprice ");
                     $customer = $result->fetch_all(MYSQLI_ASSOC);
                    foreach($customer as $customer) :?>
						<tr>
							<td><?= $customer['id']; ?></td>
                            <td><?= $customer['airtime_type']; ?></td>
                            <td>₦<?= $customer['airtime_price']; ?></td>
